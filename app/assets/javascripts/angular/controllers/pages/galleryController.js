(function(angular) {
  ...
  angular.module('datacultures.controllers').controller('GalleryController', function(galleryFactory, $scope, $routeParams, $timeout) {
    ...
    $scope.submission = function() {
      for (var i = 0; i < $scope.items.length; i++) {
        if (String($scope.items[i].id) === String($scope.imageID)) {
